...
var Cart = function () {
    ...
    (function () {
        ...
        _user_decorators = [(0, typeorm_1.ManyToOne)(function () { return user_entity_1.User; }, function (user) { return user.carts; })];
        _items_decorators = [(0, typeorm_1.OneToMany)(function () { return CartItem; }, function (cartItem) { return cartItem.cart; }, { cascade: true })];
...
var CartItem = function () {
    ...
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)()];
        _cart_decorators = [(0, typeorm_1.ManyToOne)(function () { return Cart; }, function (cart) { return cart.items; })];
