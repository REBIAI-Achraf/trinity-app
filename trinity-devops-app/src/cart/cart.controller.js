...
var CartController = function () {
    ...
    var _getCartSummary_decorators;
    ...
    var CartController = _classThis = /** @class */ (function () {
        ...
        CartController_1.prototype.addItem = function (req, createCartItemDto) {
            var userId = Number(req.user.id);
            return this.cartService.addItem(userId, createCartItemDto);
        };
        CartController_1.prototype.updateItem = function (req, itemId, updateCartItemDto) {
            var userId = Number(req.user.id);
            return this.cartService.updateItem(userId, Number(itemId), updateCartItemDto);
        };
        CartController_1.prototype.removeItem = function (req, itemId) {
            var userId = Number(req.user.id);
            return this.cartService.removeItem(userId, itemId);
        };
        CartController_1.prototype.getCartSummary = function (req) {
            var userId = Number(req.user.id);
            return this.cartService.getCartSummary(userId);
        };
        CartController_1.prototype.checkout = function (req) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.cartService.getCartSummary(userId)];
                        case 1:
                            _a.sent();
                            // Integrate the order placement and payment here
                            return [4 /*yield*/, this.cartService.clearCart(userId)];
                        case 2:
                            // Integrate the order placement and payment here
                            _a.sent();
                            return [2 /*return*/, { message: 'Checkout successful' }];
                    }
                });
            });
        };
    ...
    (function () {
        ...
        _addItem_decorators = [(0, common_1.Post)('add')];
        _updateItem_decorators = [(0, common_1.Patch)('update/:itemId')];
        _removeItem_decorators = [(0, common_1.Delete)('remove/:itemId')];
        _getCartSummary_decorators = [(0, common_1.Get)('summary')];
        ...
        __esDecorate(_classThis, null, _getCartSummary_decorators, { kind: "method", name: "getCartSummary", static: false, private: false, access: { has: function (obj) { return "getCartSummary" in obj; }, get: function (obj) { return obj.getCartSummary; } }, metadata: _metadata }, null, _instanceExtraInitializers);
