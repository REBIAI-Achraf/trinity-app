...
var NotificationsController = function () {
    ...
    var NotificationsController = _classThis = /** @class */ (function () {
        ...
        NotificationsController_1.prototype.createNotification = function (req, message) {
            var userId = parseInt(req.user.id, 10);
            return this.notificationsService.createNotification(userId, message);
        };
        NotificationsController_1.prototype.getNotifications = function (req) {
            var userId = parseInt(req.user.id, 10);
            return this.notificationsService.getNotifications(userId);
        };
        NotificationsController_1.prototype.markAsRead = function (notificationId) {
    ...
    (function () {
        ...
        _createNotification_decorators = [(0, common_1.Post)()];
