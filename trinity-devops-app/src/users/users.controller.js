...
var UsersController = function () {
    var _classDecorators = [(0, common_1.Controller)('users'), (0, common_1.UseGuards)(roles_guard_1.RolesGuard)];
    ...
    var UsersController = _classThis = /** @class */ (function () {
        ...
        UsersController_1.prototype.login = function (body) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.login(body.email, body.password)];
                        case 1:
                            token = _a.sent();
                            if (!token) {
    ...
    (function () {
        ...
        _getProfile_decorators = [(0, common_1.UseGuards)(jwt_guard_1.JwtAuthGuard), (0, common_1.Get)('profile')];
        _deleteProfile_decorators = [(0, common_1.UseGuards)(jwt_guard_1.JwtAuthGuard), (0, common_1.Delete)('profile')];
        _findAll_decorators = [(0, common_1.Get)(), (0, roles_decorator_1.Roles)(role_enum_1.Role.Admin)];
        _findOne_decorators = [(0, common_1.Get)(':id'), (0, roles_decorator_1.Roles)(role_enum_1.Role.Admin)];
        _remove_decorators = [(0, common_1.Delete)(':id'), (0, roles_decorator_1.Roles)(role_enum_1.Role.Admin)];
        _update_decorators = [(0, common_1.Patch)(':id'), (0, common_1.UseGuards)(jwt_guard_1.JwtAuthGuard)];
