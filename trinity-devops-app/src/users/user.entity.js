...
var User = function () {
    ...
    var _wishlist_decorators;
    var _wishlist_initializers = [];
    var _wishlist_extraInitializers = [];
    var User = _classThis = /** @class */ (function () {
        function User_1() {
            ...
            this.carts = (__runInitializers(this, _profile_extraInitializers), __runInitializers(this, _carts_initializers, void 0));
            this.orders = (__runInitializers(this, _carts_extraInitializers), __runInitializers(this, _orders_initializers, void 0));
            this.notifications = (__runInitializers(this, _orders_extraInitializers), __runInitializers(this, _notifications_initializers, void 0));
            this.reviews = (__runInitializers(this, _notifications_extraInitializers), __runInitializers(this, _reviews_initializers, void 0));
            this.wishlist = (__runInitializers(this, _reviews_extraInitializers), __runInitializers(this, _wishlist_initializers, void 0));
            __runInitializers(this, _wishlist_extraInitializers);
        }
        return User_1;
    }());
    ...
    (function () {
        ...
        _carts_decorators = [(0, typeorm_1.OneToMany)(function () { return cart_entity_1.Cart; }, function (cart) { return cart.user; })];
        _orders_decorators = [(0, typeorm_1.OneToMany)(function () { return order_entity_1.Order; }, function (order) { return order.user; })];
        _notifications_decorators = [(0, typeorm_1.OneToMany)(function () { return notifications_entity_1.Notification; }, function (notification) { return notification.user; })];
        _reviews_decorators = [(0, typeorm_1.OneToMany)(function () { return review_entity_1.Review; }, function (review) { return review.user; })];
        _wishlist_decorators = [(0, typeorm_1.OneToMany)(function () { return wishlist_entity_1.Wishlist; }, function (wishlist) { return wishlist.user; })];
        ...
        __esDecorate(null, null, _wishlist_decorators, { kind: "field", name: "wishlist", static: false, private: false, access: { has: function (obj) { return "wishlist" in obj; }, get: function (obj) { return obj.wishlist; }, set: function (obj, value) { obj.wishlist = value; } }, metadata: _metadata }, _wishlist_initializers, _wishlist_extraInitializers);
