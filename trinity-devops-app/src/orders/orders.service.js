...
var OrdersService = function () {
    ...
    var OrdersService = _classThis = /** @class */ (function () {
        ...
        OrdersService_1.prototype.create = function (createOrderDto) {
            var order = this.ordersRepository.create(createOrderDto);
        ...
        OrdersService_1.prototype.findOne = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.ordersRepository.findOne({ where: { id: id } })];
                        case 1:
                            order = _a.sent();
                            if (!order) {
        ...
        OrdersService_1.prototype.update = function (id, updateOrderDto) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.ordersRepository.preload(__assign({ id: id }, updateOrderDto))];
                        case 1:
                            order = _a.sent();
                            if (!order) {
                                throw new common_1.NotFoundException("Order with ID ".concat(id, " not found"));
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            order = _a.sent();
                            return [4 /*yield*/, this.ordersRepository.remove(order)];
                        case 2:
                            _a.sent();
                            return [2 /*return*/];
                    }
