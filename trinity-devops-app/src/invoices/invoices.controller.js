...
var InvoicesController = function () {
    ...
    var InvoicesController = _classThis = /** @class */ (function () {
        ...
        InvoicesController_1.prototype.getInvoice = function (orderId, res) {
            return __awaiter(this, void 0, void 0, function () {
                var invoicePath;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.invoicesService.generateInvoice(orderId)];
                        case 1:
                            invoicePath = _a.sent();
    ...
    (function () {
        ...
        _getInvoice_decorators = [(0, common_1.Get)(':orderId')];
