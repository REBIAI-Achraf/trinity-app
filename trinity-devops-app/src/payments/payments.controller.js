...
var PaymentsController = function () {
    ...
    (function () {
        ...
        _createStripePaymentIntent_decorators = [(0, common_1.Post)('stripe/create-payment-intent/:orderId')];
        _createPaypalOrder_decorators = [(0, common_1.Post)('paypal/create-order/:orderId')];
        _capturePaypalOrder_decorators = [(0, common_1.Post)('paypal/capture-order/:orderId')];
        __esDecorate(_classThis, null, _createStripePaymentIntent_decorators, { kind: "method", name: "createStripePaymentIntent", static: false, private: false, access: { has: function (obj) { return "createStripePaymentIntent" in obj; }, get: function (obj) { return obj.createStripePaymentIntent; } }, metadata: _metadata }, null, _instanceExtraInitializers);
