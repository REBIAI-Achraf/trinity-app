...
var PaypalService = function () {
    ...
    var PaypalService = _classThis = /** @class */ (function () {
        function PaypalService_1(ordersService) {
            this.ordersService = ordersService;
            this.environment = new paypal.core.SandboxEnvironment('CLIENT_ID', 'CLIENT_SECRET');
            this.client = new paypal.core.PayPalHttpClient(this.environment);
        }
        PaypalService_1.prototype.createOrder = function (orderId) {
            return __awaiter(this, void 0, void 0, function () {
                var order, request, response;
        ...
        PaypalService_1.prototype.captureOrder = function (orderId) {
            return __awaiter(this, void 0, void 0, function () {
