...
var PaymentsService = function () {
    ...
    var PaymentsService = _classThis = /** @class */ (function () {
        function PaymentsService_1(ordersService) {
            this.ordersService = ordersService;
            this.stripe = new stripe_1.Stripe('your-stripe-secret-key', {
                apiVersion: '2024-11-20.acacia',
            });
        }
        PaymentsService_1.prototype.createStripePaymentIntent = function (orderId) {
            return __awaiter(this, void 0, void 0, function () {
                var order, paymentIntent;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.ordersService.findOne(orderId)];
                        case 1:
                            order = _a.sent();
                            return [4 /*yield*/, this.stripe.paymentIntents.create({
                                    amount: order.total * 100, // Stripe amount is in cents
                                    currency: 'usd',
